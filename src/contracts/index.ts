/**
 * Contratos de API, DTOs y tipos compartidos para clientes Frontend (Angular / Ionic).
 * Este archivo puede ser importado directamente en proyectos frontend o empaquetado como módulo compartido.
 */
